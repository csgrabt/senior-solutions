...
public class CoordinateValidatorAsOptional implements ConstraintValidator<CoordinateAsOptionalDouble, Optional<Double>> {
    private Type type;


    @Override
    public void initialize(CoordinateAsOptionalDouble constraintAnnotation) {
